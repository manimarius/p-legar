...
\begin{skilgr}\label{virding}
 Virðing á baugi(sviði) $\mathbb{K}$ er vörpun $\mathbb{K} \rightarrow \mathbb{R}$ þ.a.
\begin{align*}
...
\end{cases}
\end{align}
Augljóst er að þetta skilgreinir virðingu á $\mathbb{Z}_p$.
\end{skilgr}
...
á $\mathbb{Z}_p$ skilgreint með firðinni $d(x,y) = |x-y|_p$. 
...
skilgreint $v_p(x)$ á sama hátt og áðan fyrir $x \in \mathbb{Q}_p$ og við fáum 
því að virðingin $|\cdot|_p$ framlengist á $\mathbb{Q}_p$.
...
$d(x,y) = |x-y|_p$, er staðþjappað og inniheldur $\mathbb{Z}_p$ sem 
...
\end{skilgr}
Þar sem við erum að skoða ofurfirðir þá gefur sterka þríhyrningsójafnan af sér nokkra skemmtilega eiginleika.
...
en nú er einnig
\begin{equation*}
r = d(a,b) \leq \max \{ d(a,c),\overbrace{d(b,c)}^{< r} \}
\end{equation*}
svo $d(a,c) = r$ og því $c \in S(a,r)$.
\end{proof}
...
Fyrir veldaröð $\sum_{n=0}^{\infty} a_nx^n$, eins og í $\mathbb{R}$ eða $\mathbb{C}$ með venjulega tölugildið, segjum við að hún hafi samleitnigeislann $r$ 
